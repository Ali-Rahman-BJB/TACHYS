...
BANNER
    ...
    echo -e "${C_LINE}${LINE}${C_RST}"
    echo
    echo -e "${C_SUB}Developer   ${C_RST}: Ali Rahman"
    echo -e "${C_SUB}NIS/NISN    ${C_RST}: 24020115 / 3085417291"
    echo -e "${C_SUB}Kelas       ${C_RST}: XII Teknik Komputer dan Jaringan"
    echo -e "${C_SUB}Tempat PKL  ${C_RST}: Bandung Computer Banjarbaru"
